  ...
  void _onAuthUserUpdated(AuthUserUpdated event, Emitter<AuthState> emit) {
    ...
    if (currentState is AuthAuthenticated) {
      ...
      final newAuthModel = AuthModel(
        ...
        user: event
            .updatedUser, // TODO: Instead of directly attaching the updated user use copyWith method to keep previous data  of authModel and only update the necessary fields
      );
